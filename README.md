...
Станом на 28 Січ 2024 я потімив деяку активність репозиторія та боту, проте я отримав свій паспорт досить давно, і підтримки рантайму самого бота в тг не буде, але ви завжди можете selfhostʼити чи забрати АПІ та використовувати у своїх проектах.
